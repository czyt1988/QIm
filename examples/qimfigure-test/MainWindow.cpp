...
void MainWindow::drawPlot3D()
{
    ...
    plot->setEqual(true);
    plot->setAxisLimits(QIM::QImPlot3DNode::AxisX, -1.2, 1.2, true);
    plot->setAxisLimits(QIM::QImPlot3DNode::AxisY, -1.2, 1.2, true);
    plot->setAxisLimits(QIM::QImPlot3DNode::AxisZ, -0.2, 6.5, true);
