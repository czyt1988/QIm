 ...
 * - Markers shape, size, weight, fill and outline colors
 * - Fill alpha
 * - Per-triangle coloring options
 * 
...
public:
    ...
    // Per-triangle fill color enabled property accessors
    bool isPerTriangleFillColorEnabled() const { return m_perTriangleFillColorEnabled; }
    void setPerTriangleFillColorEnabled(bool enabled);
    
    // Per-triangle line color enabled property accessors
    bool isPerTriangleLineColorEnabled() const { return m_perTriangleLineColorEnabled; }
