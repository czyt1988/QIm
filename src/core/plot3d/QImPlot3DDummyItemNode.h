#ifndef QIMPLOT3DDUMMYITEMNODE_H
#define QIMPLOT3DDUMMYITEMNODE_H
 ...
 * \endif
 */
class QIM_CORE_API QImPlot3DDummyItemNode : public QImPlot3DItemNode
{
    Q_OBJECT
...
public:
    // Unique type identifier for QImPlot3DDummyItemNode
    enum
    {
        Type = InnerType3D + 9
    };
    ...
    // Constructs a QImPlot3DDummyItemNode with optional parent
    QImPlot3DDummyItemNode(QObject* parent = nullptr);

    // Destroys the QImPlot3DDummyItemNode
...
#endif  // QIMPLOT3DDUMMYITEMNODE_H
