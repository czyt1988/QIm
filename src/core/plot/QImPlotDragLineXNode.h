 ...
 * \endif
 */
class QIM_CORE_API QImPlotDragLineXNode : public QImPlotItemNode
{
    Q_OBJECT
    QIM_DECLARE_PRIVATE(QImPlotDragLineXNode)

    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::value
     * @brief X position of the draggable vertical line
     *
     * @details Defines the x coordinate where the draggable vertical line will be rendered.
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::color
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::thickness
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::id
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::flags
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::hovered
    ...
    /**
     * \if ENGLISH
     * @property QImPlotDragLineXNode::held
...
public:
    // Unique type identifier for QImPlotDragLineXNode
    enum
    {
        Type = InnerType + 21
    };
    ...
    // Constructs a QImPlotDragLineXNode with optional parent
    QImPlotDragLineXNode(QObject* parent = nullptr);
...
protected:
    // Begins drawing the draggable vertical line
    virtual bool beginDraw() override;
};

}  // namespace QIM

#endif  // QIMPLOTDRAGLINEXNODE_H