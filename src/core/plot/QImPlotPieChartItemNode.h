...
class QIM_CORE_API QImPlotPieChartItemNode : public QImPlotItemNode
{
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::center
     * @brief Center position of pie chart in plot coordinates
     *
     * @details Controls the center of the pie chart in plot units.
     *          Default value is (0, 0).
     * @accessors READ center WRITE setCenter NOTIFY centerChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::center
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::radius
     * @brief Radius of pie chart in plot units
     *
     * @details Controls the radius of the pie chart in plot units.
     *          Default value is 1.0.
     * @accessors READ radius WRITE setRadius NOTIFY radiusChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::radius
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::labelFormat
     * @brief Format string for slice labels
     *
     * @details Controls the format of slice labels displayed on the pie chart.
     *          Uses standard printf-style formatting.
     *          Default value is "%.1f".
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::startAngle
     * @brief Starting angle in degrees
     *
     * @details Controls the starting angle of the first slice in degrees.
     *          0 degrees is at 3 o'clock, increasing counter-clockwise.
     *          Default value is 90 (12 o'clock).
     * @accessors READ startAngle WRITE setStartAngle NOTIFY startAngleChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::startAngle
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::normalize
     * @brief Normalization flag
     *
     * @details When true, forces normalization of pie chart values
     *          (i.e., always make a full circle if sum < 0).
     *          Corresponds to ImPlotPieChartFlags_Normalize.
     * @accessors READ isNormalized WRITE setNormalize NOTIFY normalizeChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::normalize
     * @brief 归一化标志
     *
     * @details 为 true 时，强制对饼图值进行归一化
     *          （即，如果总和 < 0，始终形成一个完整的圆）。
     *          对应于 ImPlotPieChartFlags_Normalize。
     * @accessors READ isNormalized WRITE setNormalize NOTIFY normalizeChanged
     * \endif
     */
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::ignoreHidden
     * @brief Ignore hidden slices flag
     *
     * @details When true, ignores hidden slices when drawing the pie chart
     *          (as if they were not there).
     *          Corresponds to ImPlotPieChartFlags_IgnoreHidden.
     * @accessors READ isIgnoreHidden WRITE setIgnoreHidden NOTIFY ignoreHiddenChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::ignoreHidden
     * @brief 忽略隐藏切片标志
     *
     * @details 为 true 时，绘制饼图时忽略隐藏的切片
     *          （就像它们不存在一样）。
     *          对应于 ImPlotPieChartFlags_IgnoreHidden。
     * @accessors READ isIgnoreHidden WRITE setIgnoreHidden NOTIFY ignoreHiddenChanged
     * \endif
     */
    ...
    /**
     * \if ENGLISH
     * @property QImPlotPieChartItemNode::exploding
     * @brief Exploding slices flag
     *
     * @details When true, legend-hovered slice is exploded (offset from center).
     *          Corresponds to ImPlotPieChartFlags_Exploding.
     * @accessors READ isExploding WRITE setExploding NOTIFY explodingChanged
     * \endif
     *
     * \if CHINESE
     * @property QImPlotPieChartItemNode::exploding
     * @brief 爆炸切片标志
     *
     * @details 为 true 时，图例悬停的切片会爆炸（从中心偏移）。
     *          对应于 ImPlotPieChartFlags_Exploding。
     * @accessors READ isExploding WRITE setExploding NOTIFY explodingChanged
     * \endif
     */
